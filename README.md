...
<h3 align="center">popup-allow</h3>

---

<p align="center">Attempting to find a solution that allows you to use `window.open()`, but also satisfies the browser requirements for opening an anchor tag in a new window/tab.</b>
    <br> 
</p>
